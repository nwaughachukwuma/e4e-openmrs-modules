 ...
 */
@SubResource(parent = ProviderResource1_9.class, path = "attribute", supportedClass = ProviderAttribute.class, supportedOpenmrsVersions = { "1.9.*", "1.10.*", "1.11.*", "1.12.*", "2.0.*", "2.1.*" })
